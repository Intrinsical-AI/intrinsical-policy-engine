...
from intrinsical_policy_engine.adapters.frameworks.layout_loader import maybe_load_framework_layout
from intrinsical_policy_engine.app.config.context import build_artifact_context
from intrinsical_policy_engine.app.rendering.templating import fill
from intrinsical_policy_engine.common.constants import (
    CANONICAL_ENGINE_NAME,
    CANONICAL_ENGINE_VERSION,
    UNKNOWN_ENGINE_COMMIT,
)
from intrinsical_policy_engine.common.hashing import sha256_file
from intrinsical_policy_engine.common.jinja_env import create_jinja_env, make_tracking_undefined
from intrinsical_policy_engine.domain.services.artifact_selector import (
    ARTIFACT_SELECTOR,
...
class ArtifactRenderer:
    ...
    def _inject_audit_info(self) -> None:
        ...
        self._ctx["engine"]["commit"] = trace.get("engine_commit") or UNKNOWN_ENGINE_COMMIT
        self._ctx["engine"]["name"] = engine_name
        self._ctx["disclaimer_version"] = DISCLAIMER_VERSION

        self._ctx.setdefault("meta", {})
        self._ctx["meta"]["user"] = self.config.generated_by
...
def _get_engine_version() -> str:
    """Return the version of the code rendering this artifact."""
...
def render_artifacts(
    ...
    Args:
        ...
        generated_by: Explicit user/service identity recorded in artifact metadata.
