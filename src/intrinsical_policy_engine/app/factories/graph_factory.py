...
Usage:
    >>> from intrinsical_policy_engine.app.factories import build_compliance_graph
    >>> from intrinsical_policy_engine.adapters.contracts.yaml import YamlContractsAdapter
...
from intrinsical_policy_engine.domain.graph import ComplianceGraphBuilder, GraphInput
from intrinsical_policy_engine.domain.graph.models import ActionNode, ArticleNode, EvidenceEntry
...
def build_compliance_graph(
    ...
    if graph_filter is not None:
        from intrinsical_policy_engine.domain.graph.filters import filter_graph
