...
from intrinsical_policy_engine.domain.constants import MAX_DERIVATION_ITERATIONS
from intrinsical_policy_engine.domain.services.rule_engine import eval_ast, parse_when
from intrinsical_policy_engine.domain.types import ConditionAST, Flag

if TYPE_CHECKING:
    from intrinsical_policy_engine.domain.contract_models import RulesContract
