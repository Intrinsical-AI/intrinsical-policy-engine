...
from intrinsical_policy_engine.domain.bundles import predicates as _predicates  # noqa: F401
...
from intrinsical_policy_engine.domain.bundles.registry import PREDICATES, PredicateRegistry
