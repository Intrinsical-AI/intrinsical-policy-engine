...
def sha256_directory(
    ...
    if path.is_symlink():
        # Preserve one fail-closed policy even for dangling directory roots.
        validated_tree_files(path)
    ...
    # Validate before reading any content. This rejects both file and directory
    # symlinks instead of silently hashing content outside the requested tree.
    tree_files = validated_tree_files(path)
