...
import intrinsical_policy_engine.domain.bundles.registry as bundle_registry
...
from intrinsical_policy_engine.domain.bundles.registry import PredicateRegistry
