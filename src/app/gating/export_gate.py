...
from src.adapters.quality.bundle_evidence_validator import (
...
def _allow_incomplete_coverage(export_mode: str, explicit_allow: bool | None = None) -> bool:
    ...
    env_allow = (
        os.getenv("IPE_ALLOW_INCOMPLETE_COVERAGE")
        or os.getenv("LEXOPS_ALLOW_INCOMPLETE_COVERAGE")
        or ""
    ).lower()
    return env_allow in {"1", "true", "yes"}
