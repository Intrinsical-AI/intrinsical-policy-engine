...
from src.adapters.export.filesystem.strategies.bundle_profile import BundleProfileStrategy
from src.adapters.export.filesystem.strategies.evidence import EvidenceStrategy
...
from src.adapters.export.filesystem.strategies.omissions import OmissionsStrategy
from src.adapters.export.filesystem.strategies.reporting import ReportingStrategy
...
class FilesystemExporter(BaseExporter):
    ...
    def _inject_regulatory_meta(self, ctx: dict[str, Any], plan: Plan) -> None:
        ...
        """
        from src.domain.services.regulatory_meta import (
