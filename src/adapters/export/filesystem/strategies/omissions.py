...
from src.adapters.export.filesystem.strategies.base import ArtifactsDelta, ExportStrategy

if TYPE_CHECKING:
    from src.adapters.export.filesystem.filesystem_exporter import FilesystemExporter
    from src.adapters.export.filesystem.strategies.base import ExportContext
