...
from src.adapters.export.base.models.config_constants import ExporterConfig
from src.adapters.logging import StructuredLogger
from src.app.config.constants import EVIDENCE_ZIP, ICS_FILE, INDEX_JSON
...
class ExportHelpers:
    ...
    def write_text(self, path: Path, content: str, base_dir: Path | str | None = None) -> None:
        ...
        if base_dir:
            from src.domain.exceptions import ExportPathError
    ...
    def append_manifest_lines(self, out_dir: str) -> list[str]:
        ...
        from src.adapters.export.base.evidence.task_api_utils import read_manifest_lines
    ...
    def quality_lines(self, out_dir: str) -> list[str]:
        ...
        """
        from src.adapters.export.base.evidence.task_api_utils import read_quality_lines
