...
from src.common.text.front_matter import strip_front_matter
from src.domain.constants import MD_DRAFT_MIN_CHARS, MD_READY_MIN_CHARS
...
class QualityEngine:
    ...
    def __init__(self, cfg: QualityConfig | None = None):
        ...
        self._gates: dict = {}
        try:
            from src.adapters.quality.gates import HITLQualityGate, ImpactReviewQualityGate
