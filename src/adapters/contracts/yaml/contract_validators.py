...
from src.domain.services.rule_engine import analyze_when, validate_when
from src.domain.validation.evidence_validator import validate_evidence_map_integrity
...
class ContractBusinessValidator:
    ...
    def validate_due_rules(self, due_rules: dict, calendar: dict, problems: list[str]) -> None:
        if not due_rules:
            return
        from src.domain.services.duedate_service import flatten_calendar
